...
int main(void) {
	...
	for (;;) {
		...
		#if DEBUG_ENABLED == 1
		itoa(buttonZ, printbuff, 10); uart_puts(printbuff); uart_puts(" ");
		itoa(buttonC, printbuff, 10); uart_puts(printbuff); uart_puts(" ");
		itoa(joyX, printbuff, 10); uart_puts(printbuff); uart_puts(" ");
		itoa(joyY, printbuff, 10); uart_puts(printbuff); uart_puts(" ");
		itoa(angleX, printbuff, 10); uart_puts(printbuff); uart_puts(" ");
		itoa(angleY, printbuff, 10); uart_puts(printbuff); uart_puts(" ");
		itoa(angleZ, printbuff, 10); uart_puts(printbuff); uart_puts(" ");
		...
		itoa((int)pitch, printbuff, 10); uart_puts(printbuff); uart_puts(" ");
		itoa((int)roll, printbuff, 10); uart_puts(printbuff); uart_puts(" ");
		#endif
